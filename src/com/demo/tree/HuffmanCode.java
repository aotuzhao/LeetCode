...
//		List<com.demo.binarysorttree.Node> nodes = getNodes(bytes);
//		//创建一颗赫夫曼树
//		com.demo.binarysorttree.Node root = createHuffmanTree(nodes);
//		//测试一下 赫夫曼树 是否创建成功!
//		//输出root 的 值
...
//	 * @return
//	 */
//	private static Map<Byte, String> getCodes(com.demo.binarysorttree.Node root) {
//
//		if(root==null) {
//			return null;
//		}
...
//	 * @param stringBuilder
//	 */
//	private static void getCodes(com.demo.binarysorttree.Node node, String code, StringBuilder stringBuilder) {
...
//	 */
//	private static List<com.demo.binarysorttree.Node> getNodes(byte[] bytes) {
//		List<com.demo.binarysorttree.Node> nodes = new ArrayList<>();
//		//存储每一个byte出现了多少次。
...
//			nodes.add(new com.demo.binarysorttree.Node(entry.getKey(), entry.getValue()));
//		}
//		return nodes;
//	}
//
...
//	 * @return 返回赫夫曼树的根节点
//	 */
//	private static com.demo.binarysorttree.Node createHuffmanTree(List<com.demo.binarysorttree.Node> nodes) {
//
//		// 循环处理，
...
//			// 取出来权值最小的两个二叉树
//			com.demo.binarysorttree.Node left = nodes.get(0);
//			// 取出最权值次小的二叉树, 作为新的二叉树的右子树
//			com.demo.binarysorttree.Node right = nodes.get(1);
//			// 创建一颗新的二叉树 ， 新的节点 data 没有，权值为两颗子树权值和
//			com.demo.binarysorttree.Node parent = new com.demo.binarysorttree.Node(null, left.weight + right.weight);
...
//class Node implements Comparable<com.demo.binarysorttree.Node> {
//	Byte data;  // 数据本身 , char 本质就是 Byte
//	int weight; // 可以理解成权值, 即字符出现的次数
//	com.demo.binarysorttree.Node left;
//	com.demo.binarysorttree.Node right;
//
...
//
//	@Override
//	public int compareTo(com.demo.binarysorttree.Node node) {
//		//这样写是从小到大排序
